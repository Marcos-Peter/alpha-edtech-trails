...
document.getElementById('lz').innerHTML = "Led Zeppelin";
document.getElementById('lz-link').href = "https://www.ledzeppelin.com/?frontpage=true";
document.getElementById('lz-link').target = "_blank";
document.getElementById('lz-img').src = "assets/led-zeppelin.jpg";
document.getElementById('tolkien').innerHTML = "J. R. R. Tolkien";
document.getElementById('tolkien-link').href = "https://pt.wikipedia.org/wiki/J._R._R._Tolkien";
document.getElementById('tolkien-link').target = "_blank";
document.getElementById('tolkien-img').src = "assets/tolkien.jpg";